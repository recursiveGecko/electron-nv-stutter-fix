/**
Including nvapi.h causes compilation errors due to some macros not being supported by Zig's translate-c.
This file contains the minimal set of structs and enums required for this program to work.
*/
...
{
     // change:Zig translate-c can't handle bitfields, and we don't need them anyway
